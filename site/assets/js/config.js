...
window.GLUK_CONFIG = {
  /* Версия сайта. */
  release: { version: "2.1.0", channel: "beta", date: "2026-09-16" },
  ...
  pricing: {
    ...
    /* Подпись под тарифами до ответа API и в режиме без биллинга: про сам
       факт оплаты здесь не пишем — способы и статус присылает сервер. */
    note: "Цены могут измениться до публичного запуска. Итоговая сумма и способ оплаты подтверждаются перед переходом к оплате.",
    plans: [
      {
        id: "free",
        name: "Free",
