...
(function () {
  ...
  var EN = {
    ...
    "Истекла": "Expired",
    "Неактивна": "Inactive",
    /* Отзыв и замена подписки: без этих строк на /en/ в карточке оставался
       бы русский текст, а до перевода там вообще стоял сырой DISABLED. */
    "Отозвана": "Revoked",
    "Заменена": "Replaced",
    "Возврат оплаты": "Refunded",
    "Нет почты": "No email",
    "не указана": "not set",
    ...
    "Нет подписки": "No subscription",
    "Проверяем платёж…": "Checking the payment…",
    "Оплата прошла — подписка подключена.": "Payment received — your subscription is active.",
    "Платёж обрабатывается — подписка включится автоматически.": "The payment is being processed — the subscription switches on automatically.",
    "Платёж ещё обрабатывается. Подписка включится сама — обновите страницу через минуту.": "The payment is still being processed. The subscription will switch on by itself — refresh the page in a minute.",
    "Платёж не прошёл. Деньги не списаны — попробуйте другую карту или оплатите ещё раз.": "The payment did not go through. Nothing was charged — try another card or pay again.",
    "Онлайн": "Online",
    "Офлайн": "Offline",
    "Отключаем…": "Disconnecting…",
    "Отключить": "Disconnect",
