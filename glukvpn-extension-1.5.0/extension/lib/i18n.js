...
const en = {
	...
	'servers.autoHint': 'Picks the fastest available server for you',
	'servers.manualLocked': 'Manual selection is available on a paid plan',
	'servers.forYou': 'For You',
	'servers.otherServers': 'Other Servers',
	'login.show': 'show',
	'login.hide': 'hide',
	'nav.profile': 'Profile',
...
const ru = {
	...
	'servers.auto': 'Авто · Лучший сервер',
	'servers.autoHint': 'Сами подберём самый быстрый доступный сервер',
	'servers.manualLocked': 'Ручной выбор доступен на платном тарифе',
	'servers.forYou': 'Для вас',
	'servers.otherServers': 'Другие серверы',
	'login.show': 'показать',
	'login.hide': 'скрыть',
	'nav.profile': 'Профиль',
	...
	'profile.revoked': 'Отозвана',
	'profile.replaced': 'Заменена',
	'profile.refunded': 'Возврат оплаты',
	...
	'settings.siteListExcept': 'Сайты напрямую (без VPN)',
	...
	'settings.killSwitch': 'Kill switch',
	'settings.killSwitchHint': 'Останавливать трафик, если шлюз упал (защита от утечек).',
