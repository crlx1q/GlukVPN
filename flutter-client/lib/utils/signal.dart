	...
	int get bars {
		switch (this) {
			...
			case SignalStrength.unknown:
				// Ни одного деления. Два серых читались как «2 из 3» — как
				// оценка, которой никто не делал: пока шли замеры, весь
				// список выглядел наполовину хорошим. Незажжённые деления
				// всё равно рисуются, так что форма не прыгает, когда придёт
				// цифра. В расширении то же правило: signalOf() -> 0.
				return 0;
